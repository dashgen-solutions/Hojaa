    ...
    return (
      <div className="flex items-center justify-center h-full bg-neutral-50">
        <div className="text-center animate-fade-in">
          ...
          <p className="text-neutral-500 font-medium">Loading project...</p>
        </div>
      </div>
    );
  }
          ...
          <>
            ...
            {showSourceSuggestions && currentSourceDetail?.suggestions && (
              <>
                ...
                />
                <div className="fixed top-[48px] bottom-0 right-0 z-[95] w-[460px] bg-white shadow-lg border-l border-neutral-200 flex flex-col">
            ...
            {selectedNode ? (
              <div className="w-full h-full flex flex-col">
                <div className="bg-white m-2 mb-0 rounded-t-md shadow-sm">
                  <ProjectToolbar
                ...
                <div className="flex-1 overflow-hidden">
                  <ResizableSplitPane
                    leftPanel={
                      <div className="h-full bg-white overflow-hidden rounded-bl-md shadow-sm ml-2 mr-1">
                        <TreeVisualization
                          sessionId={projectId}
                    ...
                    rightPanel={
                      <div className="h-full flex flex-col rounded-br-md shadow-sm mr-2 ml-1 overflow-hidden">
                        <ChatInterface
                          sessionId={projectId}
                          selectedNodeId={selectedNode}
              ...
              <div className="w-full h-full p-2">
                <div className="h-full bg-white overflow-hidden rounded-md shadow-sm flex flex-col">
                  <ProjectToolbar
                    onInputAdded={() => setShowSourceSuggestions(true)}
                    onSelectInput={() => setShowSourceSuggestions(true)}
                  />
