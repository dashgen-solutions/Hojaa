        ...
        <div className="flex items-center justify-center min-h-full py-8 px-4">
          <div className="w-full max-w-lg animate-fade-in-up">
            <div className="text-center mb-6">
              ...
              <p className="text-neutral-500">Start discovering requirements with AI</p>
            </div>
            ...
            <div className="flex gap-3 mb-6">
              ...
              >
                <BuildingOffice2Icon className={`w-6 h-6 ${registrationType === "organization" ? "text-neutral-900" : "text-neutral-400"}`} />
                <div className="text-left">
                  <div className={`text-sm font-semibold ${registrationType === "organization" ? "text-neutral-900" : "text-neutral-700"}`}>Organization</div>
                  <div className="text-xs text-neutral-500">Team & enterprise</div>
                </div>
              </button>
              <button
                type="button"
              ...
              >
                <UserIcon className={`w-6 h-6 ${registrationType === "individual" ? "text-neutral-900" : "text-neutral-400"}`} />
                <div className="text-left">
                  <div className={`text-sm font-semibold ${registrationType === "individual" ? "text-neutral-900" : "text-neutral-700"}`}>Individual</div>
                ...
                {registrationType === "organization" && (
                  <div className="space-y-4 pb-4 border-b border-neutral-100">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-xs font-semibold text-neutral-900 uppercase tracking-wider">Organization Details</span>
                    </div>
                    <div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div>
                        <label htmlFor="companySize" className="block text-sm font-medium text-neutral-700 mb-1.5">Company Size</label>
                ...
                <div className="space-y-4">
                  {registrationType === "organization" && (
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-xs font-semibold text-neutral-900 uppercase tracking-wider">Admin Account</span>
                    </div>
                  )}
                  <div>
