  ...
  return (
    <div className="flex h-full flex-col bg-white dark:bg-[#060606]">
      ...
      <div className="flex flex-1 min-h-0 overflow-hidden">
        ...
        {/* Side Panel */}
        {activePanel && (
          <div className="w-80 border-l border-neutral-200 dark:border-neutral-700 bg-[#f8f8f8] dark:bg-[#0a0a0a] flex flex-col overflow-hidden animate-in slide-in-from-right duration-200">
            {/* Panel Header */}
