    ...
    <div className="rounded-lg border border-neutral-200 bg-white p-5 animate-pulse">
      <div className="flex items-start gap-3.5">
        ...
        <div className="flex-1 min-w-0">
          <div className="h-4 w-3/4 bg-neutral-200 rounded mb-2.5" />
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center justify-between gap-4 mb-5">
        ...
        <div className="relative w-64">
          ...
          <input
            ...
            className="w-full rounded-lg border border-neutral-200 bg-white py-2 pl-9 pr-3 text-sm text-neutral-900 placeholder:text-neutral-400 focus:border-neutral-400 focus:outline-none focus:ring-1 focus:ring-neutral-400"
          />
        </div>
      </div>
      ...
      {!loading && filtered.length === 0 && (
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <p className="text-base font-medium text-neutral-900 mb-1">No documents yet</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
          {filtered.map((doc) => {
            ...
            return (
              <div
                key={doc.id}
                className={`group relative rounded-lg border border-neutral-200 border-l-[3px] ${config.accent} bg-white hover:border-neutral-300 hover:shadow-md transition-all cursor-pointer`}
              ...
              >
                ...
                >
                  <button
                    ...
                    className="rounded-md p-1 hover:bg-neutral-100 bg-white/80 backdrop-blur-sm"
                  >
                    <EllipsisVerticalIcon className="h-5 w-5 text-neutral-500" />
                  </button>
                  {openMenuId === doc.id && (
                    <div className="absolute right-0 mt-1 w-44 rounded-lg border border-neutral-200 bg-white shadow-lg z-30">
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          setOpenMenuId(null);
                        ...
                        className="flex w-full items-center gap-2 px-3 py-2 text-sm text-neutral-700 hover:bg-neutral-50 rounded-t-lg"
                      >
