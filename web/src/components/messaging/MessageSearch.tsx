...
export default function MessageSearch({ channelId, onSelectMessage, onClose }: MessageSearchProps) {
  ...
  return (
    <div className="w-[400px] border-l border-[#383a3f] bg-[#1e2024] flex flex-col h-full">
      {/* Header */}
      <div className="flex items-center gap-2 px-4 py-3 border-b border-[#383a3f]">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {!loading && results.length > 0 && (
          <>
            <div className="px-4 py-2 text-xs text-gray-500 border-b border-[#383a3f]/50">
            ...
            {results.map((msg) => (
              <button
                ...
                className="w-full text-left px-4 py-3 border-b border-[#383a3f]/30 hover:bg-[#222529] transition-colors"
              >
                ...
                <div className="text-[13px] text-gray-400 line-clamp-2">
        ...
        {!query && !loading && (
          <div className="flex flex-col items-center justify-center h-64 text-gray-500">
            <MagnifyingGlassIcon className="w-10 h-10 mb-3 text-gray-600" />
