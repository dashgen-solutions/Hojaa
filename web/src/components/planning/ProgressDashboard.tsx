  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div>
        ...
        <div className="w-full h-3 rounded-full bg-neutral-200 dark:bg-neutral-700 overflow-hidden flex">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="rounded-md border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 p-4">
          <h4 className="text-sm font-semibold text-neutral-800 dark:text-neutral-100 mb-3">Cards per Status</h4>
          <div className="space-y-2">
            {stats.columnCounts.map((col) => (
              <div key={col.key} className="flex items-center gap-3">
                <span className="text-xs text-neutral-600 dark:text-neutral-400 w-20">{col.label}</span>
                ...
                <span className="text-xs font-medium text-neutral-700 dark:text-neutral-300 w-6 text-right">{col.count}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* Priority breakdown */}
        <div className="rounded-md border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 p-4">
          <h4 className="text-sm font-semibold text-neutral-800 dark:text-neutral-100 mb-3">Priority Breakdown</h4>
          <div className="space-y-2">
            {Object.entries(PRIORITY_COLORS).map(([priority, color]) => {
              const count = stats.priorityCounts[priority] || 0;
              return (
                <div key={priority} className="flex items-center gap-3">
                  <span className="text-xs text-neutral-600 dark:text-neutral-400 w-20 capitalize">{priority}</span>
                  <div className="flex-1 h-2 rounded-full bg-neutral-100 dark:bg-neutral-700 overflow-hidden">
                    <div
                  ...
                  <span className="text-xs font-medium text-neutral-700 dark:text-neutral-300 w-6 text-right">{count}</span>
                </div>
              );
            })}
          </div>
        ...
        {/* Hours tracking */}
        <div className="rounded-md border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 p-4">
          <h4 className="text-sm font-semibold text-neutral-800 dark:text-neutral-100 mb-3">Time Tracking</h4>
          <div className="grid grid-cols-2 gap-4">
            <div>
              <p className="text-[10px] uppercase tracking-wide text-neutral-400">Estimated</p>
              <p className="text-xl font-bold text-neutral-800 dark:text-neutral-100">{stats.totalEstimated}h</p>
            </div>
            <div>
              <p className="text-[10px] uppercase tracking-wide text-neutral-400">Actual</p>
              <p className="text-xl font-bold text-neutral-800 dark:text-neutral-100">{stats.totalActual}h</p>
            </div>
          </div>
        ...
        {/* AC progress + flags */}
        <div className="rounded-md border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 p-4">
          <h4 className="text-sm font-semibold text-neutral-800 dark:text-neutral-100 mb-3">Acceptance Criteria</h4>
          <div className="flex items-center gap-4 mb-3">
            <div>
              <p className="text-[10px] uppercase tracking-wide text-neutral-400">Completed</p>
              <p className="text-xl font-bold text-neutral-800 dark:text-neutral-100">{stats.completedAC}/{stats.totalAC}</p>
            </div>
            <div className="flex-1 h-2 rounded-full bg-neutral-100 dark:bg-neutral-700 overflow-hidden">
              <div
      ...
      {workload.length > 0 && (
        <div className="rounded-md border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 p-4">
          <h4 className="text-sm font-semibold text-neutral-800 dark:text-neutral-100 mb-3">Team Workload</h4>
            ...
            <table className="w-full text-xs">
              ...
              <tbody>
                {workload.map((w) => {
                  ...
                  return (
                    <tr key={w.team_member_id} className="border-b border-neutral-50 dark:border-neutral-800">
                      <td className="py-2 font-medium text-neutral-800 dark:text-neutral-200">{w.team_member_name}</td>
                      <td className="py-2 text-center text-neutral-600 dark:text-neutral-400">{w.total_cards}</td>
                      ...
                      <td className="py-2 text-center text-neutral-600 dark:text-neutral-400">{w.estimated_hours}</td>
                      <td className="py-2 text-center text-neutral-600 dark:text-neutral-400">{w.actual_hours}</td>
                      <td className="py-2">
